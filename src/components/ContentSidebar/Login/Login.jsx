...
function Login() {
  ...
  return (
      <form className={`${formContainer } ${fade}`} onSubmit={formik.handleSubmit} key={isRegister ? 'Sign Up' : 'Sign In'}>
        <h2 className={formTitle}>
          {isRegister ? 'Sign Up' : 'Sign In'}
        </h2>

        <InputForm label="Email" name="email" id="email" isRequired formik={formik} />
        <InputForm label="Password" type="password" name="password" id="password" isRequired formik={formik} />
